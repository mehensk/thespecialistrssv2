        ...
        <div className="px-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/investor-relations" className="text-white/70 hover:text-white transition-colors">
                  Investor Relations
                </Link>
              </li>
              <li>
                <Link href="/developer-selling" className="text-white/70 hover:text-white transition-colors">
                  Developer Selling
                </Link>
              </li>
              <li>
